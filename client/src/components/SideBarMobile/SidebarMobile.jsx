...
function SidebarMobile({ className }) {
    ...
    return (
        <>
            ...
            <aside
                className={`
                hidden sm:block fixed left-0 top-0 z-40 h-screen w-16 lg:w-64
                bg-[#121212] border-r border-neutral-800 transition-all duration-300
                hover:w-64 lg:hover:w-64 overflow-hidden
                ${className}
            `}
            >
                <div className="flex flex-col h-full pt-20">
                    ...
                    {/* Bottom Navigation */}
                    <nav className="px-2 py-4 border-t border-neutral-800 space-y-2">
                ...
                <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#121212] border-t border-neutral-800 px-4 py-2">
                    <div className="flex justify-around items-center">
                        ...
                        <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
                            <SheetTrigger className="bg-amber-300" asChild>
                                <button
                                    className="flex flex-col items-center justify-center p-2 text-neutral-400 hover:text-white transition-colors duration-200"
                                >
