    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                const updateView = await videoService.incrementVideoCount(
                    video_id
                );
                const allVideosResp = await videoService.getHomeVideos();
                console.log("Got the Video In Details :: ", resp);
                console.log("Updated Video View Count :: ", updateView);
                console.log("Got all videos Count :: ", allVideosResp);
                setVideo(resp.payload);
                setAllVideos(allVideosResp.payload);
            } catch (error) {
                                    ...
                                    <div className="flex gap-x-4">
                                        ...
                                        <div className="block">
                                            ...
                                            <p className="mt-3 text-sm">
                                                This series is exactly what
                                                I&#x27;ve been looking for!
                                                Excited to dive into these
                                                advanced React patterns. Thanks
                                ...
                                <div>
                                    <div className="flex gap-x-4">
                                        ...
                                        <div className="block">
                                            ...
                                            <p className="mt-3 text-sm">
                                                Render props have always been a
                                                bit tricky for me. Can&#x27;t
                                                wait to see how this series
                                                breaks it down. Thanks for
                                                sharing!
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <div className="flex gap-x-4">
                                        ...
                                        <div className="block">
                                            ...
                                            <p className="mt-3 text-sm">
                                                Higher-order components have
                                                been a mystery to me for far too
                                                long. Looking forward to
                                                demystifying them with this
                                                series. Thanks!
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <div className="flex gap-x-4">
                                        ...
                                        <div className="block">
                                            ...
                                            <p className="mt-3 text-sm">
                                                Compound components are a
                                                game-changer for UI development.
                                                Can&#x27;t wait to learn more
                                                about them. Great work on this
                                                series!
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-x-4">
                                        ...
                                        <div className="block">
                                            ...
                                            <p className="mt-3 text-sm">
                                                ...
                                                components - finally! This topic
                                                has always confused me. Thanks
                                ...
                                <div>
                                    <div className="flex gap-x-4">
                                        ...
                                        <div className="block">
                                            ...
                                            <p className="mt-3 text-sm">
                                                This series is a goldmine for
                                                React developers! Compound
                                                components are something
                                                I&#x27;ve been eager to master.
                                                Thanks for this!
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-x-4">
                                        ...
                                        <div className="block">
                                            ...
                                            <p className="mt-3 text-sm">
                                                ...
                                                take my React skills to the next
                                                level. Looking forward to diving
                                    ...
                                    <div className="flex gap-x-4">
                                        ...
                                        <div className="block">
                                            ...
                                            <p className="mt-3 text-sm">
                                                ...
                                                learn more about controlled vs.
                                                uncontrolled components. Thanks
                                                for sharing!
                                            </p>
                                        </div>
                                    </div>
