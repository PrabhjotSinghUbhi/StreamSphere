                            ...
                            <div className="grid gap-4 pt-2 sm:grid-cols-[repeat(auto-fit,_minmax(400px,_1fr))]">
                                <div className="w-full">
                                    ...
                                    <p className="flex text-sm text-gray-200">
                                        Master the art of building dynamic user
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="flex text-sm text-gray-200">
                                        Learn the core concepts and fundamentals
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="flex text-sm text-gray-200">
                                        Dive into TypeScript for enhanced type
                                        safety and scalable JavaScript
                                        applications.
                                    </p>
                                </div>
                                <div className="w-full">
                                    ...
                                    <p className="flex text-sm text-gray-200">
                                        Explore various state management
                                        techniques in React applications.
                                    </p>
                                </div>
                                <div className="w-full">
                                    <div className="relative mb-2 w-full pt-[56%]">
                                    ...
                                    <p className="flex text-sm text-gray-200">
                                        ...
                                        and techniques for professional-level
                                        programming.
                                    </p>
                                </div>
                            </div>
